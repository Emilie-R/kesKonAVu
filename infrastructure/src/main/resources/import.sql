...
-- Create MOVIE
INSERT INTO RESOURCE (title, resource_type, category, dtype, duration, datasource, imdb_id) VALUES ('Le Grand Bleu','MOVIE', 'Drame', 'Movie', '240 minutes' , 'OMDBAPI', 'tt0095250');
...
INSERT INTO SUIVI_RESOURCE (creation_date_time, last_modification_date_time, member_id_member, resource_id_resource, status, note,progression) VALUES (current_timestamp, current_timestamp, 'ID-1', 1, 'VU', 10,100);
INSERT INTO SUIVI_RESOURCE (creation_date_time, last_modification_date_time, member_id_member, resource_id_resource, status,note,progression) VALUES (current_timestamp, current_timestamp, 'ID-2', 1, 'AVOIR',20,0);
-- Create SERIE FollowUp
INSERT INTO SUIVI_RESOURCE (creation_date_time, last_modification_date_time, member_id_member, resource_id_resource, status, note,progression) VALUES (current_timestamp, current_timestamp, 'ID-1', 2, 'VU', 10,50);
