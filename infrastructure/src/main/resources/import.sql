...
-- Create MOVIE
INSERT INTO CATALOGUE_RESOURCE (title, resource_type, category, dtype, duration, external_catalog_name, external_key) VALUES ('Le Grand Bleu','MOVIE', 'Drame', 'Resource', '240 minutes' , 'OMDBAPI', 'tt0095250');

-- Create SERIE
INSERT INTO CATALOGUE_RESOURCE (title, resource_type, category, dtype, duration, external_catalog_name, external_key, number_of_episodes, number_of_seasons) VALUES ('Game of Thrones','SERIE', 'Action, Adventure', 'Serie', '50 minutes', 'OMDBAPI', 'tt0944947', 0, 7);
